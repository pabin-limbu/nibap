...
// trpc procedures bata, we can infer the type of output of specific procedure.
// like go to -> voices router -> getall procedure -> get all return object has custom inside it, since custom is returned in an array so we take one item from array.
