...
# curl -X POST "https://changsu-pabin337--chatterbox-tts-chatterbox-serve.modal.run/generate" \
#   -H "Content-Type: application/json" \
#   -H "X-Api-Key: super-secret-key" \
#   -d '{"prompt": "Hello-from-Chatterbox.", "voice_key": "voices/system/cmpl6rcnc00026csk5qwdaef0"}' \
#   --output output.wav

# R2 cloud bucket mount (read-only, replaces Modal Volume)
R2_BUCKET_NAME = "nibap-app"
R2_ACCOUNT_ID = "62f3af860536612d9ad98786c83e4199"
R2_MOUNT_PATH = "/r2"
